...
"tst_sock.gp" using 1:2 index 1 with impulses linewidth 2 linecolor 2 title "tst_sock (null loop)"
...
"tst_sock.gp" using 1:2 index 3 with impulses linewidth 2 linecolor 2 title "tst_sock (null loop)"
...
"tst_sock.gp" using 1:2 index 5 with impulses linewidth 2 linecolor 2 title "tst_sock (null loop)"
