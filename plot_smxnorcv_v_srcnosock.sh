#!/bin/sh
# plot_smxnorcv_v_srcnosock.sh

cat <<__EOF__ | gnuplot

reset
set term png size 1200,960
set output "plot_smxnorcv_v_srcnosock-1.png"
...
title_combined = sprintf("%s\n\n%s", title_smxnorcv, title_srcnosock)
...
reset
set term png size 1200,960
set output "plot_smxnorcv_v_srcnosock-2.png"
set xlabel "Historgram bucket (ns)"
set ylabel "Bucket count (log)"
set yrange [0.5:2000000]
set logscale y
...
reset
set term png size 1200,960
set output "plot_smxnorcv_v_srcnosock-3.png"
set xlabel "Historgram bucket (ns)"
set ylabel "Bucket count (log)"
set yrange [0.5:2000000]
set logscale y
