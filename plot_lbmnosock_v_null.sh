...
set output "plot_lbmnosock_v_null-1.png"
...
"tst_lbmnosock.gp" using 1:2 index 1 with impulses linewidth 2 linecolor 2 title "tst_lbmnosock (null loop)"

reset
set term png size 1200,960
set output "plot_lbmnosock_v_null-2.png"
set xlabel "Historgram bucket (ns)"
set ylabel "Bucket count (log)"
set yrange [0.5:1000000]
set logscale y
...
"tst_lbmnosock.gp" using 1:2 index 3 with impulses linewidth 2 linecolor 2 title "tst_lbmnosock (null loop)"

reset
set term png size 1200,960
set output "plot_lbmnosock_v_null-3.png"
set xlabel "Historgram bucket (ns)"
set ylabel "Bucket count (log)"
set yrange [0.5:1000000]
set logscale y
...
"tst_lbmnosock.gp" using 1:2 index 5 with impulses linewidth 2 linecolor 2 title "tst_lbmnosock (null loop)"
